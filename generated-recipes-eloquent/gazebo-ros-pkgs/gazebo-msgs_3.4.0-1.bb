...
SRC_URI = "https://github.com/ros2-gbp/gazebo_ros_pkgs-release/archive/release/eloquent/gazebo_msgs/3.4.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "98a64d8cff694c55f36c07743321182f"
SRC_URI[sha256sum] = "b892a27574d53f28a80137631041099d58edadd7426eaa95e57974ed6b8336ad"
S = "${WORKDIR}/gazebo_ros_pkgs-release-release-eloquent-gazebo_msgs-3.4.0-1"
