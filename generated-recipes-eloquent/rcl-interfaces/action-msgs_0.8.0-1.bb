...
SRC_URI = "https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/eloquent/action_msgs/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f42de59dc0bd7166f018405174aa1629"
SRC_URI[sha256sum] = "a9cb55158313c9fb2fee02d2fecd49ceade1a6c75160f8bc7079db8df426cb4d"
S = "${WORKDIR}/rcl_interfaces-release-release-eloquent-action_msgs-0.8.0-1"
