...
SRC_URI = "https://github.com/ros2-gbp/common_interfaces-release/archive/release/eloquent/stereo_msgs/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "402ae876ee549b5ee185fb9307f244fa"
SRC_URI[sha256sum] = "77848d1aa3ecb2df1e2723602a2ed97afe4d7d9d52800956b22e2e33199cce5b"
S = "${WORKDIR}/common_interfaces-release-release-eloquent-stereo_msgs-0.8.0-1"
