...
SRC_URI = "https://github.com/ros2-gbp/qt_gui_core-release/archive/release/eloquent/qt_gui_app/1.0.7-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2379c94c057a9da41b24a582857d73cc"
SRC_URI[sha256sum] = "adbda60c1b7d7be9bd6011e23959216862b49ba43eb3db7c7e88ed00d1991163"
S = "${WORKDIR}/qt_gui_core-release-release-eloquent-qt_gui_app-1.0.7-1"
