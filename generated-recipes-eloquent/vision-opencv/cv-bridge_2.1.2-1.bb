...
SRC_URI = "https://github.com/ros2-gbp/vision_opencv-release/archive/release/eloquent/cv_bridge/2.1.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "b6171a8e689709cddf329692504ffd04"
SRC_URI[sha256sum] = "1cb11191b66c7383e64c0138a2909b2cc5e75225b3388c170896993663319b1d"
S = "${WORKDIR}/vision_opencv-release-release-eloquent-cv_bridge-2.1.2-1"
