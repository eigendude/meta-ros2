...
SRC_URI = "https://github.com/ros2-gbp/ros_testing-release/archive/release/eloquent/ros2test/0.2.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "cdc3fc74f59f8d5521af2a918e703295"
SRC_URI[sha256sum] = "cd4755b3ca02547f41df06c4ff4bc9bc94eb0d5f27af3b94a3c7b9de837628e8"
S = "${WORKDIR}/ros_testing-release-release-eloquent-ros2test-0.2.0-1"
