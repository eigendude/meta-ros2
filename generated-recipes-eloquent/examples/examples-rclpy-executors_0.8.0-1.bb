...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/eloquent/examples_rclpy_executors/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "6bc4102ed8e96e681b32c3ba5dd199ea"
SRC_URI[sha256sum] = "1e21be14b843924e120ef8217ba1ba606ba491057848919917dd1d53a3bd1748"
S = "${WORKDIR}/examples-release-release-eloquent-examples_rclpy_executors-0.8.0-1"
