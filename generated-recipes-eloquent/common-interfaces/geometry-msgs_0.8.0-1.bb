...
SRC_URI = "https://github.com/ros2-gbp/common_interfaces-release/archive/release/eloquent/geometry_msgs/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "98122ed4471f645ec283e5e4d85e0f00"
SRC_URI[sha256sum] = "bd3879324b53febe000e9c04f7b4c1663a5b17e3dca3e8fe2fc8a98a87d3975a"
S = "${WORKDIR}/common_interfaces-release-release-eloquent-geometry_msgs-0.8.0-1"
