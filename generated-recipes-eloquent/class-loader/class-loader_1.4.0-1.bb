...
SRC_URI = "https://github.com/ros2-gbp/class_loader-release/archive/release/eloquent/class_loader/1.4.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "5be2dc813363ac195e7d884580c4fb10"
SRC_URI[sha256sum] = "79177401ea6ace156ebba466796cff3ee598e291b0b04ee8e329d8e9f4ca6205"
S = "${WORKDIR}/class_loader-release-release-eloquent-class_loader-1.4.0-1"
