...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/eloquent/ament_cmake_gmock/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f20b565cee0d17faaf000ce81d813a9a"
SRC_URI[sha256sum] = "d84931747730bf6e98efd7563e8a8bb72ca9ed602fade907259fe1e616d24c68"
S = "${WORKDIR}/ament_cmake-release-release-eloquent-ament_cmake_gmock-0.8.0-1"
