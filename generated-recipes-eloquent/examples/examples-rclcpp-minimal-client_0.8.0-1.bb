...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/eloquent/examples_rclcpp_minimal_client/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "c8ee19af6f55752e4f3674ad3d1de26f"
SRC_URI[sha256sum] = "5b09bdde53919be9a20098180fef3a84cb99a7ce7f300f261fae68fc04c86824"
S = "${WORKDIR}/examples-release-release-eloquent-examples_rclcpp_minimal_client-0.8.0-1"
