...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/eloquent/examples_rclcpp_minimal_timer/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "03530ffac59e53f0c4bd09e9b50df8eb"
SRC_URI[sha256sum] = "dc229c1facad38627516c65c306d05d1276d6d11b0ae0944ce1a0379f954e936"
S = "${WORKDIR}/examples-release-release-eloquent-examples_rclcpp_minimal_timer-0.8.0-1"
