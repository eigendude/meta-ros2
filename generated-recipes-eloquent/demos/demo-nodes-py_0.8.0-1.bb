...
SRC_URI = "https://github.com/ros2-gbp/demos-release/archive/release/eloquent/demo_nodes_py/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4031f236c1061de97c368ebf1cb63b9e"
SRC_URI[sha256sum] = "a95044177e9a38553d1bca935cf919009d7d8b0b34ae80a7b0e2abeb6891421c"
S = "${WORKDIR}/demos-release-release-eloquent-demo_nodes_py-0.8.0-1"
