...
SRC_URI = "https://github.com/ros2-gbp/teleop_twist_keyboard-release/archive/release/eloquent/teleop_twist_keyboard/2.3.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "17d06e573fd420b49ed972644d60f1ea"
SRC_URI[sha256sum] = "6d9bf888cc4e1a9d042447a54df75d6d7c9bd907d69709ad2c48d853695f7934"
S = "${WORKDIR}/teleop_twist_keyboard-release-release-eloquent-teleop_twist_keyboard-2.3.1-1"
