...
SRC_URI = "https://github.com/ros2-gbp/rclcpp-release/archive/release/dashing/rclcpp_components/0.7.10-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "05990410724668a84cc8acaf2a89bd3e"
SRC_URI[sha256sum] = "9e9b541e77a0f1200af78f97fc4b8524ce0fff3dc973a0b0b26dc1bd48813ed1"
S = "${WORKDIR}/rclcpp-release-release-dashing-rclcpp_components-0.7.10-1"
