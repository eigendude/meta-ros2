...
SRC_URI = "https://github.com/ros2-gbp/robot_state_publisher-release/archive/release/eloquent/robot_state_publisher/2.3.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d376584a5ce1e5e85837c7418e11ab09"
SRC_URI[sha256sum] = "ac17c2746ebfeb3040738128133a1f28fa80ad475a0f519b5ff663bb0a119fa0"
S = "${WORKDIR}/robot_state_publisher-release-release-eloquent-robot_state_publisher-2.3.0-1"
