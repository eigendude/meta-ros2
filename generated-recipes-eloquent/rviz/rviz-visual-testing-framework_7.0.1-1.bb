...
SRC_URI = "https://github.com/ros2-gbp/rviz-release/archive/release/eloquent/rviz_visual_testing_framework/7.0.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "de0e41b2d5dcd2ea1cebbba154675814"
SRC_URI[sha256sum] = "d04cd767db102d2da668eabef28c019d50aa37745ee7560f1a90baa94a67da43"
S = "${WORKDIR}/rviz-release-release-eloquent-rviz_visual_testing_framework-7.0.1-1"
