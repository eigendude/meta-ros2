...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/eloquent/examples_rclcpp_minimal_composition/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "c9d2ff33d16a7698e11e3aec519bf534"
SRC_URI[sha256sum] = "f870ed0628f824c83bf9f273f27a5fd3b9417cda9ce2ac46a3130a114037170a"
S = "${WORKDIR}/examples-release-release-eloquent-examples_rclcpp_minimal_composition-0.8.0-1"
