...
SRC_URI = "https://github.com/ros2-gbp/common_interfaces-release/archive/release/eloquent/shape_msgs/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "7aafab6e2a22a206987f5852caaadc54"
SRC_URI[sha256sum] = "0132c0dbeea29dd40b09866cf74086a3c2fe59179fc7b5ee6a73a7115a1a9983"
S = "${WORKDIR}/common_interfaces-release-release-eloquent-shape_msgs-0.8.0-1"
