...
SRC_URI = "https://github.com/ros2-gbp/eigen_stl_containers-release/archive/release/eloquent/eigen_stl_containers/1.0.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "aa47ede45bb20677859fe4f7e7d7ee97"
SRC_URI[sha256sum] = "d051e69abe8e3187adcb4e79925dc9a1b098e108b91dba5f76433066b54e0e77"
S = "${WORKDIR}/eigen_stl_containers-release-release-eloquent-eigen_stl_containers-1.0.0-1"
