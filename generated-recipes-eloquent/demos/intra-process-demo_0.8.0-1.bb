...
SRC_URI = "https://github.com/ros2-gbp/demos-release/archive/release/eloquent/intra_process_demo/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "ca62f1ea0ee2e95e8ecc11f552fb6a03"
SRC_URI[sha256sum] = "c3109438a55651a7db67cca50c0dc5a635d76fc7228c91de7beb647a32413b85"
S = "${WORKDIR}/demos-release-release-eloquent-intra_process_demo-0.8.0-1"
