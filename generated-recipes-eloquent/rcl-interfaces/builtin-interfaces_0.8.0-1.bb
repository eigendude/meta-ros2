...
SRC_URI = "https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/eloquent/builtin_interfaces/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "4d890cdbf8f96ee3f39fdf3efa76cf32"
SRC_URI[sha256sum] = "397dd47fde4f6bab25e221858a45058d86a7c84bfcb0e0cec157a223ed87a9da"
S = "${WORKDIR}/rcl_interfaces-release-release-eloquent-builtin_interfaces-0.8.0-1"
