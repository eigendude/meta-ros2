...
SRC_URI = "https://github.com/ros2-gbp/rosidl_defaults-release/archive/release/eloquent/rosidl_default_runtime/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "297c1ffd07cc5d29cd61704601a0fabc"
SRC_URI[sha256sum] = "7af02d123e82b2d94c8cad1af2539d1fbd656ec310e59075f07f06931bd7caa7"
S = "${WORKDIR}/rosidl_defaults-release-release-eloquent-rosidl_default_runtime-0.8.0-1"
