...
SRC_URI = "https://github.com/ros2-gbp/ament_lint-release/archive/release/eloquent/ament_cmake_pep257/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "92a4f496dd3ac0d1d681e79f942826ac"
SRC_URI[sha256sum] = "e9083094fa90ac980a6343fe8bef18d4301bcdaf5e2c6134ce015466d6733294"
S = "${WORKDIR}/ament_lint-release-release-eloquent-ament_cmake_pep257-0.8.0-1"
