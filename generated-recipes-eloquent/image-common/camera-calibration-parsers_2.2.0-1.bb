...
SRC_URI = "https://github.com/ros2-gbp/image_common-release/archive/release/eloquent/camera_calibration_parsers/2.2.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "c6707440a89a395ad1dda5e06672622f"
SRC_URI[sha256sum] = "9f86f738fc321210e40257cd9f68f172d5bb549b65829c3baa399939f2593e18"
S = "${WORKDIR}/image_common-release-release-eloquent-camera_calibration_parsers-2.2.0-1"
