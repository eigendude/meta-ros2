...
SRC_URI = "https://github.com/ros2-gbp/rqt-release/archive/release/eloquent/rqt_gui_py/1.0.5-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "2781b5e2830dbf91944069c9605a8cc0"
SRC_URI[sha256sum] = "a3d22b4428692e17dceb3518030a60137cc52a1dac898ea1a0336f20845308e0"
S = "${WORKDIR}/rqt-release-release-eloquent-rqt_gui_py-1.0.5-1"
