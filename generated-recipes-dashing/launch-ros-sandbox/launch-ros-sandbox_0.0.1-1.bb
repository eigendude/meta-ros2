...
AUTHOR = "AWS ROS Contributions <ros-contributions@amazon.com>"
...
ROS_TEST_DEPENDS = " \
    ${ROS_UNRESOLVED_PLATFORM_PKG_ament_mypy} \
    ament-copyright \
    ament-flake8 \
    ament-pep257 \
    python3-pytest \
...
SRC_URI = "https://github.com/aws-gbp/launch_ros_sandbox-release/archive/release/dashing/launch_ros_sandbox/0.0.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "6f85f6c5fd482a9f5a21744b6a2ffd9d"
SRC_URI[sha256sum] = "6f3fed8ee88bf0b148548bfb18cf65cff76c88f5d148ac29bd288b4ca8c2756a"
S = "${WORKDIR}/launch_ros_sandbox-release-release-dashing-launch_ros_sandbox-0.0.1-1"
