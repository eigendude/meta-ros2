...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/eloquent/ament_cmake_include_directories/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f514b9a1dbed4b37bdcec9feed46fc89"
SRC_URI[sha256sum] = "56be59553f6acb31b7e6941174e5d4dff056384a13cd65811fa9850768304f5d"
S = "${WORKDIR}/ament_cmake-release-release-eloquent-ament_cmake_include_directories-0.8.0-1"
