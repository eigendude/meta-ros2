...
SRC_URI = "https://github.com/ros2-gbp/ament_lint-release/archive/release/eloquent/ament_cmake_pclint/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "926c036d5a383b0d22b794998f7beb70"
SRC_URI[sha256sum] = "ef9c93ee7b6bc2eb73d5c0e1f32f70a3e10c2e905d9167855f88b513c2d449b5"
S = "${WORKDIR}/ament_lint-release-release-eloquent-ament_cmake_pclint-0.8.0-1"
