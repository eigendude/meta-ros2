...
SRC_URI = "https://github.com/ros2-gbp/ament_cmake-release/archive/release/eloquent/ament_cmake_target_dependencies/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d5ab0bda597c14ed213a719acda4a1c5"
SRC_URI[sha256sum] = "78e1d4894fade27af5b3a6e2a35e43be7a4581a6ea9db79a0463b47ffd785e57"
S = "${WORKDIR}/ament_cmake-release-release-eloquent-ament_cmake_target_dependencies-0.8.0-1"
