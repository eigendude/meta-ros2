...
SRC_URI = "https://github.com/ros2-gbp/rosbag2-release/archive/release/eloquent/rosbag2/0.2.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "3bca886b049130546555e7341cd257c3"
SRC_URI[sha256sum] = "41eaa0600aeb21c26f6a1d10c5e1b2eb5882db60394920ce9422bf4e1af77a49"
S = "${WORKDIR}/rosbag2-release-release-eloquent-rosbag2-0.2.0-1"
