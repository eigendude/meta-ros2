...
SRC_URI = "https://github.com/ros2-gbp/geometry2-release/archive/release/eloquent/tf2/0.12.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "cad37edd3e8ee1a76be190eb6e1971be"
SRC_URI[sha256sum] = "a1cd58cfc14a7b44016e9953ce856a257285042bf30dae27d7dd983c36e72f24"
S = "${WORKDIR}/geometry2-release-release-eloquent-tf2-0.12.0-1"
