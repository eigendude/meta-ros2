...
SRC_URI = "https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/eloquent/theora_image_transport/2.2.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "3a2c39fc167b5d9d655bec00e86d479e"
SRC_URI[sha256sum] = "f125b14f352f75fb3942de3c44e362fb94a24a7b74941a006337b6f866931d0f"
S = "${WORKDIR}/image_transport_plugins-release-release-eloquent-theora_image_transport-2.2.0-1"
