...
SRC_URI = "https://github.com/ros2-gbp/ament_lint-release/archive/release/eloquent/ament_clang_format/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "51cf26f5b2b784dfab72e54255ce2d8c"
SRC_URI[sha256sum] = "25cbdd2444efc5b20bd7cd1c05c56003ab798ed3746dbf9a2fb53ee308dfce77"
S = "${WORKDIR}/ament_lint-release-release-eloquent-ament_clang_format-0.8.0-1"
