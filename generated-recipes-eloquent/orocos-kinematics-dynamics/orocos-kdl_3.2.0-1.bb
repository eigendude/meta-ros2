...
SRC_URI = "https://github.com/ros2-gbp/orocos_kinematics_dynamics-release/archive/release/eloquent/orocos_kdl/3.2.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "e472c062c504f99198c95b5f8b364e2c"
SRC_URI[sha256sum] = "79e85b3f656ec505831523c5329f19cb829d9de7d653ff8c0647cc567aaeda69"
S = "${WORKDIR}/orocos_kinematics_dynamics-release-release-eloquent-orocos_kdl-3.2.0-1"
