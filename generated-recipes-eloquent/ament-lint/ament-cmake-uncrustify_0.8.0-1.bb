...
SRC_URI = "https://github.com/ros2-gbp/ament_lint-release/archive/release/eloquent/ament_cmake_uncrustify/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a6fef0f80a406dbd3f10e59a8d21d931"
SRC_URI[sha256sum] = "1a845cabda64e960be476ef11ea12bb630bc249e07f1845d81c33f1cb5ddca29"
S = "${WORKDIR}/ament_lint-release-release-eloquent-ament_cmake_uncrustify-0.8.0-1"
