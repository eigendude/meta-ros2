...
SRC_URI = "https://github.com/ros2-gbp/launch-release/archive/release/eloquent/launch_xml/0.9.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d51bbd80cbdf2448557b328d7ea0d720"
SRC_URI[sha256sum] = "d737dec0a321e3340e337def1a17990bd4afd61b39ad48315036db682ea28f4b"
S = "${WORKDIR}/launch-release-release-eloquent-launch_xml-0.9.1-1"
