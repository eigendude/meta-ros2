...
SRC_URI = "https://github.com/ros2-gbp/image_common-release/archive/release/eloquent/camera_info_manager/2.2.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "8dbf166fcdab0b37512e472141126545"
SRC_URI[sha256sum] = "d315005b8a9814489cb40820b63672ce2d720ecd4f5d4d99c4910ab99c199f6d"
S = "${WORKDIR}/image_common-release-release-eloquent-camera_info_manager-2.2.0-1"
