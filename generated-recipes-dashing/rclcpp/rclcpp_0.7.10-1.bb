...
SRC_URI = "https://github.com/ros2-gbp/rclcpp-release/archive/release/dashing/rclcpp/0.7.10-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "ba08c8db0d4fe992504e86d8375fb8e9"
SRC_URI[sha256sum] = "3782bd7866e5ac4a017a3b09775217d1fbc830ad73a93bbcfcffe9feaa41718c"
S = "${WORKDIR}/rclcpp-release-release-dashing-rclcpp-0.7.10-1"
