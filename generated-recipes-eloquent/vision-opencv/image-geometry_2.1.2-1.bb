...
SRC_URI = "https://github.com/ros2-gbp/vision_opencv-release/archive/release/eloquent/image_geometry/2.1.2-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f6066167a6036c15bd769b14f1ee7203"
SRC_URI[sha256sum] = "230552e8359f135bd44320eb2d36983c1c36b2ce47f3d3490642f9a04d3092dd"
S = "${WORKDIR}/vision_opencv-release-release-eloquent-image_geometry-2.1.2-1"
