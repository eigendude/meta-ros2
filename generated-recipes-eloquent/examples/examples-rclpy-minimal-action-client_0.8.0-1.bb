...
SRC_URI = "https://github.com/ros2-gbp/examples-release/archive/release/eloquent/examples_rclpy_minimal_action_client/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d71cc0e5fb86f9e4cfb3a90cfd23fa42"
SRC_URI[sha256sum] = "2c275ab3bcfb86a9d1a55011a8f1bcc6064257c69792ae665b0c21b322a30f57"
S = "${WORKDIR}/examples-release-release-eloquent-examples_rclpy_minimal_action_client-0.8.0-1"
