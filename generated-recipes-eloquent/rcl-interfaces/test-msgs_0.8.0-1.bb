...
SRC_URI = "https://github.com/ros2-gbp/rcl_interfaces-release/archive/release/eloquent/test_msgs/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "679a0d5d0ee5e79aaf626a95b4fdc89a"
SRC_URI[sha256sum] = "c97ae84534fd1d96327578d1fb31a84b982e0acec049dba7faff0a3fa17d42f3"
S = "${WORKDIR}/rcl_interfaces-release-release-eloquent-test_msgs-0.8.0-1"
