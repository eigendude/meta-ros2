...
SRC_URI = "https://github.com/ros2-gbp/image_transport_plugins-release/archive/release/eloquent/compressed_depth_image_transport/2.2.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "ee7752db751ee9fc2da4dbf026a224af"
SRC_URI[sha256sum] = "9d09aa31db3493bf4b42e7f957af7f9794fa02e4a0260df01fae305615d1c36f"
S = "${WORKDIR}/image_transport_plugins-release-release-eloquent-compressed_depth_image_transport-2.2.0-1"
