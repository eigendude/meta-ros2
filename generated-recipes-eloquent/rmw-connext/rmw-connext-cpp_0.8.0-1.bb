...
SRC_URI = "https://github.com/ros2-gbp/rmw_connext-release/archive/release/eloquent/rmw_connext_cpp/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "f18f1c290dc1eb0189eb9a893f835679"
SRC_URI[sha256sum] = "e742328a764c7cbc313f3768f7c624594fe64ee34a385264332a5399d24e040c"
S = "${WORKDIR}/rmw_connext-release-release-eloquent-rmw_connext_cpp-0.8.0-1"
