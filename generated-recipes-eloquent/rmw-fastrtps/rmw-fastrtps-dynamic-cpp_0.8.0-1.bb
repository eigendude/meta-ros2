...
SRC_URI = "https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/eloquent/rmw_fastrtps_dynamic_cpp/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "a5cc93a6d53b74b9ce0e4d9329b95026"
SRC_URI[sha256sum] = "3bdd56c2020f1a550e40c974cc789bcabb5bcf4db338c5338b929fc18ad7971b"
S = "${WORKDIR}/rmw_fastrtps-release-release-eloquent-rmw_fastrtps_dynamic_cpp-0.8.0-1"
