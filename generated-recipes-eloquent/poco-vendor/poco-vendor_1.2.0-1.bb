...
SRC_URI = "https://github.com/ros2-gbp/poco_vendor-release/archive/release/eloquent/poco_vendor/1.2.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "afb12f115388aa4a1de7a350557122b6"
SRC_URI[sha256sum] = "2f6821e6d7d7c9a429217ddfb2a0b71b87efbf7d4adea3e7f17d11fbed71a1e3"
S = "${WORKDIR}/poco_vendor-release-release-eloquent-poco_vendor-1.2.0-1"
