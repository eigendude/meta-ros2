...
SRC_URI = "https://github.com/ros2-gbp/ament_lint-release/archive/release/eloquent/ament_clang_tidy/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "0e562596b6db68ce475fc79dfad675e3"
SRC_URI[sha256sum] = "02cfdfd0d899426938c628c5c1dadb2847d7eb388a6b9c1f2657f01c0baecc40"
S = "${WORKDIR}/ament_lint-release-release-eloquent-ament_clang_tidy-0.8.0-1"
