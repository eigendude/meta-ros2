...
SRC_URI = "https://github.com/ros2-gbp/rmw_fastrtps-release/archive/release/eloquent/rmw_fastrtps_cpp/0.8.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "10f1474a0712a872071e263555bcd895"
SRC_URI[sha256sum] = "415a6ce6801700219a78ca49ee7657651294589822c79cb0f27fc38b2a77da26"
S = "${WORKDIR}/rmw_fastrtps-release-release-eloquent-rmw_fastrtps_cpp-0.8.0-1"
