...
SRC_URI = "https://github.com/ros2-gbp/rosbridge_suite-release/archive/release/dashing/rosbridge_server/1.0.1-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "d72fc12ffd27418a63c50cc6dfa3629c"
SRC_URI[sha256sum] = "3831574ea72158788db83fb1736a7c344b644308b47c27d9e8dabbc772c7772e"
S = "${WORKDIR}/rosbridge_suite-release-release-dashing-rosbridge_server-1.0.1-1"
