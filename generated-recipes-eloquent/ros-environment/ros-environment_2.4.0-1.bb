...
SRC_URI = "https://github.com/ros2-gbp/ros_environment-release/archive/release/eloquent/ros_environment/2.4.0-1.tar.gz;downloadfilename=${ROS_SP}.tar.gz"
SRC_URI[md5sum] = "eb9a86b759ccac2a9555205b29f17a1b"
SRC_URI[sha256sum] = "052949ee5da65f655bd74a57a40ee3eb201efdec0689082b41925a073171342d"
S = "${WORKDIR}/ros_environment-release-release-eloquent-ros_environment-2.4.0-1"
